...
{
    public partial class NitrousGasPanel : MetroForm
    {
        public NitrousGasPanel()
        {
            InitializeComponent();
        ...
        private void NitrousGasPanel_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void submitBtn_Click_1(object sender, EventArgs e)
        {
            ...
            if (manu.Text==""||functionalOption1.Text == "" || functionalOption2.SelectedItem == null || functionalOption3.SelectedItem == null || functionalOption4.SelectedItem == null
