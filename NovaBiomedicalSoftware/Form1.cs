...
namespace NovaBiomedicalSoftware
{
    ...
    public partial class Form1 : MetroForm
    {
        ...
        public string ESTResults, COMPORTNUMBER, _currentTest, _testPDF, _earthResistance, _versionNumber, _MV1, _MV2, _MV3, _insulationResistance,
        ...
        public bool runProgram, PTtestIsDone, yesNoPerformanceTest, PTisSubmitted, _electricaltestResult, _PTStestResult, class1ASNZtest, class2ASNZtest, ecgclass1ASNZtest, ecgclass2ASNZtest;
        ...
        private void class1testBtn_Click(object sender, EventArgs e)
        {
            ...
            _currentTest = "AS NZS 3551 – Class 1";
            class1ASNZtest = true;
        ...
        private void class2testBtn_Click(object sender, EventArgs e)
        {
            ...
            _currentTest = "AS NZS 3551 – Class 2";
            class2ASNZtest = true;
            ...
            while (PTtestIsDone == false)
            {
                ...
                if (perfusorSpaceTestDR == DialogResult.Cancel)
                {
                    if (perfusorSpaceTest.perfusorTest_Submit == true)
                    {
                        ...
                        PTtestIsDone = true;
                        //make PDF
                        //MessageBox.Show("Making PDF");
                    }
                    else
                    {
                        DialogResult dialogResult = MessageBox.Show("Continue?", "Performance test not completed!", MessageBoxButtons.YesNo);
        ...
        public void testComplete()
        {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                else
                {
                    ...
                    //create a report without performance test
                    createReport();
                }
            });
        }
        ...
        public void earthResistance()
        {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                if (_earthResistance_double > 0.2)
                {
                    ...
                    MessageBox.Show("Value: " + _earthResistance_double.ToString(), "Earth Resistance Test Failed");
                }
                else
                {
        ...
        public void insulationResistance()
        {
            ...
            else
            {
                ...
                this.Invoke((MethodInvoker)delegate
                {
                    ...
                    MessageBox.Show("Value: < 100 Mohms", "Insulation Resistance Test Failed");
                    labelIR.Text = _insulationResistance;
                });
            }
            mySerialPort.WriteLine("LOCAL");
        ...
        public void earthLeakage()
        {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                {
                    Thread.CurrentThread.Abort();
                    MessageBox.Show("Value: " + _EL1_double.ToString(), "Earth Leakage Current (Normal Condition) Test Failed");
                }
                else
                {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                {
                    Thread.CurrentThread.Abort();
                    MessageBox.Show("Value: " + _EL2_double.ToString(), "Earth Leakage Current (Open Neutral) Test Failed");
                }
                else
        ...
        public void enclousureLeakage()
        {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                {
                    Thread.CurrentThread.Abort();
                    MessageBox.Show("Value: " + _EnL1_double.ToString(), "Enclousure Leakage Current (Normal Condition) Test Failed");
                }
                else
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                {
                    Thread.CurrentThread.Abort();
                    MessageBox.Show("Value: " + _EnL2_double.ToString(), "Enclousure Leakage Current (Open Neutral) Test Failed");
                }
                else
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                {
                    Thread.CurrentThread.Abort();
                    MessageBox.Show("Value: " + _EnL3_double.ToString(), "Enclousure Leakage Current (Open Earth) Test Failed");
                }
                else
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                {
                    Thread.CurrentThread.Abort();
                    MessageBox.Show("Value: " + _EnL4_double.ToString(), "Enclousure Leakage Current (Normal Condition, Reversed Mains) Test Failed");
                }
                else
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                {
                    Thread.CurrentThread.Abort();
                    MessageBox.Show("Value: " + _EnL5_double.ToString(), "Enclousure Leakage Current (Open Neutral, Reversed Mains) Test Failed");
                }
                else
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                {
                    Thread.CurrentThread.Abort();
                    MessageBox.Show("Value: " + _EnL6_double.ToString(), "Enclousure Leakage Current (Open Earth, Reversed Mains) Test Failed");
                }
                else
        ...
        public void createReport()
        {
            ...
            {
                File.Copy(appRootDir + "/Employees/Report Templates/"+ userName.Text +"-CLASS1-TEMPLATE.docx", appRootDir + "/Employees/Report Templates/temp.docx");
                CreateWordDocument(appRootDir + "/Employees/Report Templates/temp.docx");
            }

            if (class2ASNZtest == true)
            {
                File.Copy(appRootDir + "/Employees/Report Templates/" + userName.Text + "-CLASS2-TEMPLATE.docx", appRootDir + "/Employees/Report Templates/.docx");
                CreateWordDocument(appRootDir + "/Employees/Report Templates/temp.docx");
            }
        ...
        private void CreateWordDocument(object fileName)
        {
            ...
            if (File.Exists((string)fileName))
            {
                ...
                this.FindAndReplace(wordApp, "<ClassStandard>", _currentTest);
            ...
            //export to pdf
            wDoc.ExportAsFixedFormat(appRootDir + "/Employees/Report Templates/" + assetNumber.Text + "-" + location.Text + ".pdf", Word.WdExportFormat.wdExportFormatPDF);

            //Close the document - you have to do this.
            wDoc.Close(ref missing, ref missing, ref missing);

            //delete the temporary file
            File.Delete(appRootDir + "/Employees/Report Templates/temp.docx");
        }
        ...
        //            || _EnL4_double > 100 || _EnL5_double > 500 || _EnL6_double > 500 || _insulationResistance == "FAILED"
        //            || _EL1_double == 0 || _EL2_double == 0 || _EnL1_double == 0 || _EnL2_double == 0 || _EnL3_double == 0
        //            || _EnL4_double == 0 || _EnL5_double == 0 || _EnL6_double == 0 || _insulationResistance == null)
        //        {
        //            _electricaltestResult = false;
        //        }
        ...
        //            || _EL1_double == 0 || _EL2_double == 0 || _EnL1_double == 0 || _EnL2_double == 0 || _EnL3_double == 0
        //            || _EnL4_double == 0 || _EnL5_double == 0 || _EnL6_double == 0 || _insulationResistance == null || PLT1_double == 0
        //            || PLT2_double == 0 || PLT3_double == 0 || SFN_double == 0)
        //        {
        //            _electricaltestResult = false;
        //        }
        //        else
        ...
        //            PdfPCell testheading = new PdfPCell(new Phrase());
        ...
        //    byte[] bytes = File.ReadAllBytes(appRootDir + "/PDFs/" + assetNumber.Text + "-" + model.Text + "-" + location.Text + ".pdf");
        //    iTextSharp.text.Font blackFont = FontFactory.GetFont(FontFactory.HELVETICA_BOLD, 12f);
        ...
        //    }
        //    File.WriteAllBytes(appRootDir + "/PDFs/" + assetNumber.Text + "-" + model.Text + "-" + location.Text + ".pdf", bytes);
        //}
    }
}
