...
{
    public partial class OxygenReticulationAlarm : MetroForm
    {
        public OxygenReticulationAlarm()
        {
            InitializeComponent();
        }
        public bool oxygenReticulationTest_Submit;
        ...
        {
            oxygenReticulationTest_Submit = false;
            this.Close();
        }
        ...
        private void submitBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                oxygenReticulationTest_Submit = true;
                this.Hide();
            }
        }
