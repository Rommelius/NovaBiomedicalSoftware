...
{
    public partial class ElectricSuction : MetroForm
    {
        public ElectricSuction()
        {
            InitializeComponent();
        }
        ...
        public bool ElectricSuctionTest_Submit;
        ...
        {
            ElectricSuctionTest_Submit = false;
            this.Close();
        }
        ...
        private void submitBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ElectricSuctionTest_Submit = true;
                this.Hide();
            }
        }
