...
{
    public partial class SphygmoHandheld : MetroForm
    {
        public SphygmoHandheld()
        {
            InitializeComponent();
        }

        public bool SphygmoHandheldTest_Submit;
        ...
        {
            SphygmoHandheldTest_Submit = false;
            this.Close();
        }
        ...
        private void submitBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SphygmoHandheldTest_Submit = true;
                this.Hide();
            }
        }
