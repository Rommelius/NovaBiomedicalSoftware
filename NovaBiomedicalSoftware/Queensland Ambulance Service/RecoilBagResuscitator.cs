...
{
    public partial class RecoilBagResuscitator : MetroForm
    {
        public RecoilBagResuscitator()
        {
            InitializeComponent();
        }
        ...
        {
            RecoilBagResuscitatorTest_Submit = false;
            this.Close();
        }
        ...
        private void submitBtn_Click(object sender, EventArgs e)
        {
            ...
            if (result_1.SelectedItem == null || result_2.SelectedItem == null || result_3.SelectedItem == null|| result_4.SelectedItem == null || result_5.SelectedItem == null)
            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    RecoilBagResuscitatorTest_Submit = true;
                    this.Hide();
                }
            }
        }
