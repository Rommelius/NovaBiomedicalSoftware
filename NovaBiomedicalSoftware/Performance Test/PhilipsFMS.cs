...
{
    public partial class PhilipsFMS : MetroForm
    {
        public bool philipsFMS_Submit;
        ...
        {
            philipsFMS_Submit = false;
            this.Close();
        }

        private void PhilipsFMS_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void submitBtn_Click(object sender, EventArgs e)
        {
            ...
            if (result_1.SelectedItem == null || result_2.SelectedItem == null || result_3.SelectedItem == null ||
                result_4.SelectedItem == null || overall.Text == "")
            {
