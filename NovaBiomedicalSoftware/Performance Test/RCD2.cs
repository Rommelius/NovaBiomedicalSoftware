...
{
    public partial class RCD2 : MetroForm
    {
        public RCD2()
        {
            InitializeComponent();
        ...
        private void RCD2_SizeChanged(object sender, EventArgs e)
        {
        ...
        public static string functionaloption1, functionaloption2, functionaloption3, functionaloption4,
            ...
            functionaloption24, functionaloption25, functionaloption26, functionaloption27,
            functionaloption28, functionaloption29, functionaloption30, functionaloption31, functionaloption32,
            functionaloption33, functionaloption34, functionaloption35, functionaloption36, functionaloption37, functionaloption38, functionaloption39, comments, items, inputresult1,
            inputresult2, inputresult3, performanceresult;
        ...
        private void submitBtn_Click_1(object sender, EventArgs e)
        {
            ...
            if (functionalOption1.SelectedItem == null || functionalOption2.SelectedItem == null || functionalOption3.SelectedItem == null || functionalOption4.SelectedItem == null
                ...
                || functionalOption14.SelectedItem == null || functionalOption15.SelectedItem == null || functionalOption16.Text == "" ||
                functionalOption17.Text == "" || functionalOption18.SelectedItem == null || functionalOption19.SelectedItem == null
                ...
                || functionalOption24.SelectedItem == null || functionalOption25.SelectedItem == null || functionalOption26.SelectedItem == null || functionalOption27.SelectedItem == null
                || functionalOption28.SelectedItem == null || functionalOption29.SelectedItem == null || functionalOption30.SelectedItem == null || functionalOption31.SelectedItem == null
                || functionalOption32.SelectedItem == null || functionalOption33.SelectedItem == null || functionalOption34.SelectedItem == null
                || functionalOption35.SelectedItem == null || functionalOption36.SelectedItem == null || functionalOption37.SelectedItem == null || functionalOption38.SelectedItem == null || functionalOption39.SelectedItem == null 
                || result1.Text == "" || result2.Text == "" || result3.Text == "" || overall.SelectedItem == null)
            {
            ...
            else
            {
                ...
                inputresult1 = result1.Text;
                inputresult2 = result2.Text;
                inputresult3 = result3.Text;
                //comments box
