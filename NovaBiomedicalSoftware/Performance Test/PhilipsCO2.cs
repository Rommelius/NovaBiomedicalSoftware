...
{
    public partial class PhilipsCO2 : MetroForm
    {
        ...
        private void PhilipsCO2_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void submitBtn_Click(object sender, EventArgs e)
        {
            ...
            if (result_1.SelectedItem == null || result_2.SelectedItem == null || result_3.Text == "" ||
                result_4.SelectedItem == null || result_5.Text == "" || result_4.Text == "" ||
                result_5.Text == "" || result_6.Text == "" || result_7.Text == "" ||
                result_8.Text == "" || result_9.SelectedItem == null)
            {
            ...
            else
            {
                ...
                performanceresult = result_9.Text;
                //visual
