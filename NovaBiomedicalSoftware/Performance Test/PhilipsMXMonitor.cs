...
{
    public partial class PhilipsMXMonitor : MetroForm
    {
        ...
        private void PhilipsMXMonitor_SizeChanged(object sender, EventArgs e)
        {
            commentBox.Width = safetyCheck.Width - 10;
            listBox1.Width = safetyCheck.Width - 10;
        }

        public PhilipsMXMonitor()
        {
            InitializeComponent();
        ...
        private void submitBtn_Click(object sender, EventArgs e)
        {
            ...
            if (result_1.SelectedItem == null || result_2.SelectedItem == null || result_3.SelectedItem == null ||
                ...
                result_9.SelectedItem == null || result_9.SelectedItem == null)
            {
