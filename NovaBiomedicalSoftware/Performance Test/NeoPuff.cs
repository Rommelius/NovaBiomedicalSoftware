...
{
    public partial class NeoPuff : MetroForm
    {
        public NeoPuff()
        {
            InitializeComponent();
        ...
        private void NeoPuff_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void submitBtn_Click(object sender, EventArgs e)
        {
            ...
            if (result_1.SelectedItem == null || result_2.SelectedItem == null || result_3.SelectedItem == null ||
                ...
                result_12.SelectedItem == null ||
                result_13.SelectedItem == null ||
                result_14.SelectedItem == null || overall.SelectedItem == null)
            {
