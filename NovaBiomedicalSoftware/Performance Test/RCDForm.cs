...
{
    public partial class RCDForm : MetroForm
    {
        public RCDForm()
        {
            InitializeComponent();
        ...
        private void RCDForm_SizeChanged(object sender, EventArgs e)
        {
        ...
        public static string functionaloption1, functionaloption2, functionaloption3, functionaloption4,
            ...
            functionaloption28, functionaloption29, functionaloption30, functionaloption31, functionaloption32, comments, items, inputresult1,
            inputresult2, inputresult3, inputresult4, performanceresult;
        ...
        private void submitBtn_Click_1(object sender, EventArgs e)
        {
            ...
            if (functionalOption1.SelectedItem == null || functionalOption2.SelectedItem == null || functionalOption3.SelectedItem == null || functionalOption4.SelectedItem == null
                ...
                || functionalOption32.SelectedItem == null ||  result1.Text==""||result2.Text==""||result3.Text==""||result4.Text=="" || overall.SelectedItem == null)
            {
