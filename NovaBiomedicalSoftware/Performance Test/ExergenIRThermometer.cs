...
{
    public partial class ExergenIRThermometer : MetroForm
    {
        public bool Test_Submit;

        public static string result1, result2, result3, result4, result5, result6, input1, input2, performanceresult;
        ...
        private void ExergenIRThermometer_SizeChanged(object sender, EventArgs e)
        {
